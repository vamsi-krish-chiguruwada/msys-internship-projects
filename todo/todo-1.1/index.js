...
//     }
 ...
 document.querySelector("#todoInput").addEventListener("keyup",function(){
     if (event.keyCode === 13) {
         addTodo();
        }
 });
 ...
 function showPending(){
     ...
     document.getElementById("todo-ul").style.display="none";
     document.getElementById("span-todo-ul").style.display="block";
 ...
 function showAll(){
    ...
    document.getElementById("todo-ul").style.display="block";
    document.getElementById("span-todo-ul").style.display="none";
